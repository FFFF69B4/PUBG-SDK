...
// Enum TslGame.EThrowDistance
enum class EThrowDistance : uint8_t
{
	Short                          = 0,
	Long                           = 1,
	MAX                            = 2,
	EThrowDistance_MAX             = 3
};


// Enum TslGame.EHolsterType
enum class EHolsterType : uint8_t
{
	Rifle_Primary                  = 0,
	Rifle_Secondary                = 1,
	Pistol                         = 2,
...
// Enum TslGame.EGunSlotType
enum class EGunSlotType : uint8_t
{
	Rifle_Primary                  = 0,
	Rifle_Secondary                = 1,
	Pistol                         = 2,
...
enum class EWeaponSlotType : uint8_t
{
	...
	Melee                          = 3,
	MAX                            = 4,
	EWeaponSlotType_MAX            = 5
};


// Enum TslGame.EKangarooAmmoType
enum class EKangarooAmmoType : uint8_t
{
	Ammo_12_Gauge                  = 0,
	Ammo_SMG                       = 1,
	Ammo_556mm                     = 2,
	Ammo_762mm                     = 3,
	MAX                            = 4,
	EKangarooAmmoType_MAX          = 5
};


// Enum TslGame.UCollectibleSpecialEffect
enum class EUCollectibleSpecialEffect : uint8_t
{
	None                           = 0,
	Heal                           = 1,
	UniversalAmmo                  = 2,
	MAX                            = 3,
	UCollectibleSpecialEffect_MAX  = 4
};


// Enum TslGame.EKangarooDifficulty
enum class EKangarooDifficulty : uint8_t
{
	Easy                           = 0,
	Normal                         = 1,
	Hard                           = 2,
	MAX                            = 3,
	EKangarooDifficulty_MAX        = 4
};


// Enum TslGame.FGunCategory
enum class EFGunCategory : uint8_t
{
	Pistol                         = 0,
	Shotgun                        = 1,
	SMG                            = 2,
...
// Enum TslGame.EKangarooAimingType
enum class EKangarooAimingType : uint8_t
{
	Classic                        = 0,
	Synthetik                      = 1,
	Arcade                         = 2,
	EKangarooAimingType_MAX        = 3
};


// Enum TslGame.EDropShellMoment
enum class EDropShellMoment : uint8_t
{
	OnReload                       = 0,
	OnShoot                        = 1,
	OnChamber                      = 2,
	EDropShellMoment_MAX           = 3
};


// Enum TslGame.EGunActionType
enum class EGunActionType : uint8_t
{
	BOLT_ACTION                    = 0,
	SEMI_AUTOMATIC                 = 1,
	AUTOMATIC                      = 2,
	EGunActionType_MAX             = 3
};
...
// Enum TslGame.EKangarooLobbyMenuItem
enum class EKangarooLobbyMenuItem : uint8_t
{
	Kangaroo_Lobby_HardMode        = 0,
	Kangaroo_Lobby_Start           = 1,
	Kangaroo_Lobby_Leaderboard     = 2,
	Kangaroo_Lobby_Help            = 3,
	Kangaroo_Lobby_QuitGame        = 4,
	Kangaroo_Lobby_MAX             = 5
};


// Enum TslGame.EKangarooSystemMenuItem
enum class EKangarooSystemMenuItem : uint8_t
{
	Kangaroo_System_Resume         = 0,
	Kangaroo_System_Upgrade        = 1,
	Kangaroo_System_Help           = 2,
	Kangaroo_System_GiveUp         = 3,
	Kangaroo_System_QuitGame       = 4,
	Kangaroo_System_MAX            = 5
};
...
enum class EGuideKeyType : uint8_t
{
	...
	QuickPickUp                    = 17,
	QuickDrop                      = 18,
	SwitchSlotAndSwapWeapon        = 19,
	DropWeapon                     = 20,
	SwapWeapon                     = 21,
	PickUpAndHoldQuickEquip        = 22,
...
enum class EBBDetachedBehaviour : uint8_t
{
	...
	MoveToCenterOfMap              = 1,
	Expand                         = 2,
	ExpandAndMoveToCenterOfMap     = 3,
	EBBDetachedBehaviour_MAX       = 4
};
...
// Enum TslGame.FKangarooBingoH3Upgrade
enum class EFKangarooBingoH3Upgrade : uint8_t
{
	PointBlank                     = 0,
	TriggerHappy                   = 1,
	Sharpshooter                   = 2,
	...
	MAX                            = 4,
	Easier_Headshots               = 5,
	DamageUp_CloseRange            = 6,
	DamageUp_FarRange              = 7,
	FKangarooBingoH3Upgrade_MAX    = 8
};


// Enum TslGame.FKangarooBingoV3Upgrade
enum class EFKangarooBingoV3Upgrade : uint8_t
{
	RunAndGun                      = 0,
	Exploiter                      = 1,
	TacticoolReloads               = 2,
	Sniper                         = 3,
	MAX                            = 4,
	Reduced_Damage_After_TakingDamage = 5,
	Grenade_Damage_Bonus           = 6,
	FKangarooBingoV3Upgrade_MAX    = 7
};


// Enum TslGame.FKangarooDefaultUpgrade
enum class EFKangarooDefaultUpgrade : uint8_t
{
	LuckyPan                       = 0,
	TacticalRoll                   = 1,
	ExtMagazine                    = 2,
	...
	RedDotSight                    = 15,
	MAX                            = 16,
	Higher_RPM_After_Roll          = 17,
	Shotgun_Damage_Up              = 18,
	SMG_Damage_Up                  = 19,
	AR_Damage_Up                   = 20,
	LMG_Damage_Up                  = 21,
	DMR_SR_Damage_Up               = 22,
	SG_Bullets_Penetrate_Enemies   = 23,
	SMG_Larger_Mag                 = 24,
	AR_Larger_Mag                  = 25,
	Heavy_Larger_Mag               = 26,
	SR_Bullets_Penetrate_Enemies   = 27,
	Shotgun_Faster_Reload          = 28,
	SMG_Faster_Reload              = 29,
	AR_Faster_Reload               = 30,
	LMG_Faster_Reload              = 31,
	DMR_SR_Faster_Reload           = 32,
	Choke                          = 33,
	Vertical_Grip                  = 34,
	Angle_Grip                     = 35,
	Bipod                          = 36,
	Finger_Grip                    = 37,
	Double_Magazine_Size_But_Same_Ammo_Consumed = 38,
	Melee_Drain                    = 39,
	Overall_Damage_Bonus           = 40,
	Faster_Melee                   = 41,
	Overall_Less_Spread            = 42,
	Movement_Speed_Bonus_Per_Kill  = 43,
	FKangarooDefaultUpgrade_MAX    = 44
};
...
// Enum TslGame.EGateTransition
enum class EGateTransition : uint8_t
{
	None                           = 0,
	Close                          = 1,
	Open                           = 2,
	EGateTransition_MAX            = 3
};


// Enum TslGame.EEnemyWaveMode
enum class EEnemyWaveMode : uint8_t
{
	BossHealthBased                = 0,
	Sequential                     = 1,
	InfiniteIfBossAlive            = 2,
	EEnemyWaveMode_MAX             = 3
};
...
// Enum TslGame.FGridCell
enum class EFGridCell : uint8_t
{
	Background                     = 0,
	Floor                          = 1,
	WallT                          = 2,
...
// Enum TslGame.FGridCellObject
enum class EFGridCellObject : uint8_t
{
	None                           = 0,
	Gate                           = 1,
	SpawnArea                      = 2,
	...
	Enemy                          = 5,
	EnemyWaypoint                  = 6,
	ObstacleAndDecoration          = 7,
	FGridCellObject_MAX            = 8
};
...
// Enum TslGame.EAISignalType
enum class EAISignalType : uint8_t
{
	Sight                          = 0,
	Hearing                        = 1,
	Damage                         = 2,
...
// Enum TslGame.EBBKeyName
enum class EBBKeyName : uint8_t
{
	SelfActor                      = 0,
	Enemy                          = 1,
	AIState                        = 2,
...
// Enum TslGame.EKangarooTestCommandGun
enum class EKangarooTestCommandGun : uint8_t
{
	AKM                            = 0,
	AUG                            = 1,
	Beryl                          = 2,
	...
	Win94                          = 24,
	MAX                            = 25,
	EKangarooTestCommandGun_MAX    = 26
};


// Enum TslGame.EKangarooTestCommandBasicGun
enum class EKangarooTestCommandBasicGun : uint8_t
{
	BasicCrossbow                  = 0,
	BasicPistol                    = 1,
	BasicRevolver                  = 2,
	BasicSawedOff                  = 3,
	MAX                            = 4,
	EKangarooTestCommandBasicGun_MAX = 5
};


// Enum TslGame.FKangarooUpgradeType
enum class EFKangarooUpgradeType : uint8_t
{
	KUT_NONE                       = 0,
	KUT_NEGATE_DAMAGE              = 1,
	KUT_ROLL_DMG_BOOST             = 2,
	KUT_EXT_MAG                    = 3,
	KUT_QUICKDRAW_MAG              = 4,
	KUT_LOWER_HP_HIGHER_DMG        = 5,
	KUT_ROLL_MOVEMENT_BOOST        = 6,
	KUT_ROLL_RECOVERY              = 7,
	KUT_VEST                       = 8,
	KUT_MORE_DMG_TO_UNDAMAGED_ENEMY = 9,
	KUT_PATIENCE                   = 10,
	KUT_MELEE_SHOCK                = 11,
	KUT_GRENADE_SHOCK              = 12,
	KUT_GRENADE_BURN               = 13,
	KUT_AMMO_CAP_INC               = 14,
	KUT_MORE_HEALING               = 15,
	KUT_INC_CRIT                   = 16,
	KUT_REMOVE_MOVING_SPREAD       = 17,
	KUT_DEBUFF_ALWAYS_CRIT         = 18,
	KUT_FASTER_RELOAD              = 19,
	KUT_FARTHER_MORE_DMG           = 20,
	KUT_CLOSER_MORE_DMG            = 21,
	KUT_CONT_FIRE_MORE_DMG         = 22,
	KUT_MORE_CRIT_DMG              = 23,
	KUT_AMMO_DROP_INC              = 24,
	KUT_MAX                        = 25
};


// Enum TslGame.EUpgradeFamily
enum class EUpgradeFamily : uint8_t
{
	Default                        = 0,
	BingoV3                        = 1,
	BingoH3                        = 2,
	BingoH5                        = 3,
	EUpgradeFamily_MAX             = 4
};


// Enum TslGame.EEggsplosivesAttackType
enum class EEggsplosivesAttackType : uint8_t
{
	GunSweep                       = 0,
	ThrowGrenades                  = 1,
	Kamikaze                       = 2,
	ThrowKnives                    = 3,
	Lunges                         = 4,
	BrandishOrRevolver             = 5,
	GunSweepSecondary              = 6,
	MissilesLaunch                 = 7,
	Ramming                        = 8,
	KamikazeRobots                 = 9,
	MAX                            = 10,
	EEggsplosivesAttackType_MAX    = 11
};


// Enum TslGame.EKamikazeState
enum class EKamikazeState : uint8_t
{
	None                           = 0,
	Igniting                       = 1,
	Flying                         = 2,
	Stunned                        = 3,
	PullingBack                    = 4,
	EKamikazeState_MAX             = 5
};


// Enum TslGame.EMeleeAttackType
enum class EMeleeAttackType : uint8_t
{
	None                           = 0,
	Swing                          = 1,
	Lunge                          = 2,
	EMeleeAttackType_MAX           = 3
};
...
// Enum TslGame.FSizeGroup
enum class EFSizeGroup : uint8_t
{
	Large                          = 0,
	Medium                         = 1,
	Small                          = 2,
...
// Enum TslGame.FObstacleMode
enum class EFObstacleMode : uint8_t
{
	None                           = 0,
	ColliderBound                  = 1,
	RenderBound                    = 2,
...
// Enum TslGame.FLevelDirection
enum class EFLevelDirection : uint8_t
{
	Downwards                      = 0,
	Upwards                        = 1,
	FLevelDirection_MAX            = 2
};
